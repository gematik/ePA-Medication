= Medication Service der "ePA für alle"
:title-page:
...
Die nachstehende Abbildung verdeutlicht die Kommunikationsflüsse für das Löschen einer Verordnung in den Medication Service per FHIR Operation. 
