...
Alias: $kbv-medication-type-cs =  https://fhir.kbv.de/CodeSystem/KBV_CS_ERP_Medication_Type
Alias: $kbv-medication-darreichungsform = https://fhir.kbv.de/CodeSystem/KBV_CS_SFHIR_KBV_DARREICHUNGSFORM
