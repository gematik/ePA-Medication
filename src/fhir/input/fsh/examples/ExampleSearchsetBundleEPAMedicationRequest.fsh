...
* entry[0].fullUrl = "http://epa4all.de/epa/medication/api/v1/fhir/MedicationRequest/bb91cde8-0426-4f4b-a766-5d818d0605bd"
* entry[0].resource = ExampleEpaMedicationRequest1
* entry[0].search.mode = #match

* entry[1].fullUrl = "http://epa4all.de/epa/medication/api/v1/fhir/MedicationRequest/3d7252b4-7814-4d40-8ca2-2f731648f22d"
