...
* entry[0].fullUrl = "https://epa-as-0.prod.epa4all.de/vau-cid-1234/epa/medication/api/v1/fhir/MedicationDispense/4e6e1623-778e-44a3-b208-8479f5339e43"
* entry[0].resource = ExampleEpaMedicationDispense1
* entry[0].search.mode = #match

* entry[1].fullUrl = "https://epa-as-0.prod.epa4all.de/vau-cid-1234/epa/medication/api/v1/fhir/MedicationDispense/46865835-8c8f-4139-86ba-271bd3565250"
