...
* entry[0].fullUrl = "http://epa4all/epa/medication/api/v1/fhir/Medication/2571d29b-e213-40ec-b817-a1490718a490"
* entry[0].resource = ExampleEpaMedication1
* entry[0].search.mode = #match

* entry[1].fullUrl = "http://epa4all/epa/medication/api/v1/fhir/Medication/3b990824-3814-4d75-80b1-e2935827f8f0"
* entry[1].resource = ExampleEpaMedication2
* entry[1].search.mode = #match

* entry[2].fullUrl = "http://epa4all/epa/medication/api/v1/fhir/Medication/4bfef107-7d81-4d36-8aa0-7ea937969046"
* entry[2].resource = ExampleEpaMedication3
* entry[2].search.mode = #match

* entry[3].fullUrl = "http://epa4all/epa/medication/api/v1/fhir/Medication/4f9ab221-0eef-4e46-a8a9-38302e0488b1"
